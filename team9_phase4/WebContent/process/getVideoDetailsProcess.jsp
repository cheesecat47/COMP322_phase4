...
<%
	...
	try {
		System.out.println("getVideoDetailsProcess: id:" + id);
		
		String sql = "select m.movie_register_no, m.movie_title, m.movie_type, m.movie_runtime, m.movie_start_year, c.genre_name" +
		...
		System.out.println("getVideoDetailsProcess: e: " + e);
		e.printStackTrace();
    } finally {
        db.closeConnDB();
        data.put("data", rs_data);
        response.setContentType("application/json");
        System.out.println("getVideoDetailsProcess: data: " + data);
